# --------------------------------------------------
# 2-Sets Venn Diagram Plotting Function (Proportional, Nature Style)
# 
# This script defines a function `plot_venn_2sets()` that generates a 2-sets 
...
# --------------------------------------------------
# Function: plot_venn_2sets
# Description: Plots a 2-sets Venn diagram with Nature-style aesthetics.
# Parameters:
...
# --------------------------------------------------
plot_venn_2sets <- function(set1,
                            set2,
                            set1_name = "Set 1",
                            set2_name = "Set 2",
                            output_file = "venn_2sets.png",
